...
public class BrowserUtils {
	private static final Logger console = LoggerFactory.getLogger(BrowserUtils.class);
	...
	public static void switchToWindow(String targetTitle) {
		...
		console.info("switched to {} w{\n" +
				...
				"\t\t}\n" +
				"\t\tDriver.get().switchTo().window(origin);\n" +
				"\t\tconsole.info(\"switched to {} window \",targetTitle);\n" +
				"\t}indow ",targetTitle);
	}
	...
	public static void hover(WebElement element) {
		...
		console.info("hovering on element is successfull");
	}
	...
	public static List<String> getElementsText(List<WebElement> list) {
		...
		console.info("element text {} retrived from the list of webelements",elemTexts.toString());
		return elemTexts;
	}
	...
	/**
	 * Extract the element text for specified locator
	 * 
	 *
	 * @param locator
	 * @return String
	 */
	public static String getElementText(By locator,String locatorname) {
		String text = null;
		waitForVisibility(locator, 30);
		text = Driver.get().findElement(locator).getText().trim();
		return text;
	}
	 ...
	 * @return String
	 */
	public static String getElementText(WebElement element,String locatorName) {
		String text = null;
		//waitForVisibility(element, 10);
		text = element.getText().trim();
		console.info("text {} is retrived for {} field",text,locatorName);
		return text;
	}
	...
	public static void waitFor(int seconds) {
		try {
			console.info("waiting for {} time",String.valueOf(seconds));
	...
	public static WebElement waitForVisibility(WebElement element, int timeToWaitInSec) {
		...
		console.info("waiting for element {} element to be visible",element);
	...
	public static WebElement waitForVisibility(By locator, int timeout) {
		...
		console.info("waiting for element {} element to be visible",locator);
	 ...
	 *             if the element matching the provided locator is not found or not
	 *             displayed
	 */
	 ...
	 * @param by
	 * @throws AssertionError
	 *             the element matching the provided locator is displayed
	 */
	 ...
	 * @param element
	 * @throws AssertionError
	 *             if the element is not found or not displayed
	 */
	...
	public static void clickWithJS(WebElement element,String elementName) {
		...
		console.info("clicked on {} element with {} locator",elementName,element);
	}
	 ...
	 * @param element
	 */
	public static void typeText(WebElement element, String txt,String name) {
		waitForVisibility(element, 60);
		element.clear();
		element.sendKeys(txt);
		console.info("{} text has been typed in {} field",txt,name);
	}
	...
	public static void clickWithWait(By by, int attempts) {
		...
		while (counter < attempts) {
			try {
				...
				clickWithJS(Driver.get().findElement(by),"element");
